...
public class TpaCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        teleportationManager.addRequest(player, target, false);

        player.sendMessage(ChatColor.GREEN + "Teleport request sent to " + target.getName() + ".");
        target.sendMessage(ChatColor.GREEN + player.getName() + " wants to teleport to you. Type /tpaccept to accept, or /tpdeny to deny.");
